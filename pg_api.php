<?php
/**
 * PG System API — Puente entre el HTML y la base de datos MySQL
 * ─────────────────────────────────────────────────────────────
 * INSTRUCCIONES:
 *   1. Cambia DB_USER y DB_PASS por tus credenciales de Bluehost
 *   2. Sube este archivo al mismo directorio que tu HTML del PG System
 *   3. Listo — el sistema guardará en la BD automáticamente
 */

// ── CONFIGURACIÓN ─────────────────────────────────────────────
define('DB_HOST', 'localhost');
define('DB_USER', 'emzmuumy_ISABEL_MEDICARE');   // ← Tu usuario MySQL de Bluehost
define('DB_PASS', 'Up-fkdugnuqv');  // ← Tu contraseña MySQL
define('DB_NAME', 'emzmuumy_CRM_MEDICAREWITHISABEL');       // ← Nombre de tu base de datos
