...
import { learningBriefLine } from './learning.js';
...
export function buildBriefing(now = new Date()) {
  ...
  const nothing = !alto.length && !aviso.length && !overdue.length && !due.length && !gaps.length && !growth && !learn;
