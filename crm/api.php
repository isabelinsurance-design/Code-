...
case 'save_plan_comparacion':
    ...
    // Migración: si la tabla ya existía con VARCHAR (versión anterior), se
    // ensancha a TEXT una sola vez — algunos textos reales no cabían.
...
case 'save_member':
    ...
    $all_fields = ['nombre','middle_name','apellido','telefono','telefono2','estado','subestado','agente_id',
        ...
        'referido_por_texto','referido_por_miembro_id','campana_origen_id',
...
function _describir_cambios_miembro(array $old, array $fields_presentes, array $vals_nuevos): array {
    static $labels = [
        ...
        'referido_por_miembro_id'=>'REFERIDO POR (MIEMBRO)','campana_origen_id'=>'CAMPAÑA DE ORIGEN','plan'=>'PLAN','carrier'=>'CARRIER',
