  ...
  <div style="background:linear-gradient(135deg,<?= $P1 ?>,<?= $P2 ?>);border-radius:13px;padding:16px 18px;margin-bottom:13px;display:flex;gap:13px;align-items:flex-start;flex-wrap:wrap">
    ...
    <div style="flex:1;min-width:180px">
      ...
      <div style="display:flex;gap:4px;flex-wrap:wrap">
        ...
        <?php if (($m['subestado']??'')==='DECEASED'): ?><span style="background:rgba(0,0,0,.35);color:#fff;border:1px solid rgba(255,255,255,.3);border-radius:20px;padding:2px 9px;font-size:8px;font-weight:900;letter-spacing:.5px;text-transform:uppercase">🕊 FALLECIDO/A</span><?php endif; ?>
